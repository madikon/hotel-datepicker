      ...
      dayClicked(day) {
        ...
        if (isSelectStart) {
          ...
          if (season) {
            ...
            let nextBooked = null;
            if (this.bookedDays) {
              prevBooked = this.bookedDateTimes.filter(d => d < this.start).sort((a, b) => b - a)[0];
              nextBooked = this.bookedDateTimes.filter(d => d > this.start).sort((a, b) => a - b)[0];
            }
